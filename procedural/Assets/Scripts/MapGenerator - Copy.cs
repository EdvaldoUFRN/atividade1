...
public class MapGenerator : MonoBehaviour
{
    ...
    void PlaceFloorPrefab()
    {
        ...
        // Encontra todos os espaços sem paredes
        ...
        // Garante que exista ao menos um espaço sem paredes
        if (openTiles.Count > 0)
        {
            System.Random rand = new System.Random();
            floorPosition = openTiles[rand.Next(openTiles.Count)]; // Seleciona uma posição aleatória
